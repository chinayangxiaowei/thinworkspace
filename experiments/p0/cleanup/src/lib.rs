//! Pure parsing and removal-policy experiments for P0-07.
//!
//! This crate performs no Git, filesystem, process, logging, or deletion I/O.
//! It is not a Phase 1 Port or service implementation.
