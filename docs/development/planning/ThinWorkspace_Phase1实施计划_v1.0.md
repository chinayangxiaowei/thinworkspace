...
当前顺序：设计文档与 P0-06 已完成 → P0-07 tracked-only 检查 → P0-05 已排期锁实验 → P0-04 故障闭环。P0-06 已获规定模型正式 Approve，审核后真实 Verification、精确候选完整 CI 与代码 PR 合并均完成；基线、工作区、保真范围、CI 修复、实际模型和保留边界统一见 [P0-06 实施记录](../implementation/P0-06_原始目录镜像实验.md)的最终收口。P0-07 尚未领取；P0-06 Done 不代表 P0.b 或整个 P0 放行，也不扩大 P0-01/P0-02 的历史验证范围。
